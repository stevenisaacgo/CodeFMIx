<template>
    <nav class="flex justify-between py-2 px-8 text-[#dbdbdb]">
        <div class="flex md:flex justify-between items-center gap-8">
            ...
            >
                <div>
                    <MenuButton
                        class="inline-flex w-full justify-center gap-x-1.5 bg-[#242424] px-3 py-2 font-semibold text-[#dbdbdb] outline-none hover:border-0 active:border-0"
                        @mouseover="open = true"
                    >
                        Lenguajes
                        <ChevronDownIcon
            ...
            <span class="text-lg work-sans">Final Score: {{ score }}</span>
